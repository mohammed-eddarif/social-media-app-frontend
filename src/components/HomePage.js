          ...
          <div>
            ...
            <Row>
              <h3 className="my-3">
                ...
                welcome to the most secure social media app
              </h3>
            </Row>
             <Row>
              <h3 className="my-3">
                 {/* <BsGithub /> The source code is open */} 
                 If you face any problems , just contact us in the following email :
              </h3>
            </Row>
             <Row>
              <h3 className="my-3">
                 <BsFillEnvelopeFill /> mohammed.eddarif06@gmail.com 
              </h3>
            </Row> 
          </div>
        </Col>
